	...
	public DlgRectangleDrawingApp(boolean modifyMode) {
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				if(modifyMode) {
					borderColorButton.setActionCommand("BORDER COLOR");
					shapeColorButton.setActionCommand("SHAPE COLOR");
					borderColorButton.setFont(new Font("Tahoma", Font.PLAIN, 15));
					shapeColorButton.setFont(new Font("Tahoma", Font.PLAIN, 15));
